...
const session_id = ref('30c0aa7b-ade1-4c4c-9312-617443b4187c')
...
onMounted(() => {
	nextTick(async () => {
		// get the session id from the URL query parameter if it exists, otherwise use the default using nuxt's useRoute composable
		const route = useRoute()
		session_id.value = route.params.id
		await FetchData()
		await FetchData2()
		await FetchData3()
		await FetchData4()
